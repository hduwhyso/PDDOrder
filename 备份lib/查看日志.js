 ...
 * @Date: 2024-06-10 10:45:24
 * @LastEditTime: 2024-06-10 10:45:27
 * @Description: 
 */
/*
 * @Author: TonyJiangWJ
...
let { config, default_config, storage_name, project_name } = require('./config.js')(runtime, global)
...
let logPath = files.getSdcardPath()+ '/' +project_name + '/logs/log-verboses.log'
