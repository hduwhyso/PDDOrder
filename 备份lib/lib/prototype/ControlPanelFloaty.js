 ...
 * @LastEditTime: 2024-06-08 17:36:49
 * @Description: 
 */
      ...
      _this.floatyWindow = floaty.rawWindow(
        <horizontal id="controlPanel">    
            <vertical  w="60sp" h="auto" bg="#00000000" gravity="center|top">  
                ...
                <button id="delete" text="删单" h="40" w="60sp"/>
...
ControlPanelFloaty.prototype.hide = function () {
  ...
  ui.run(function () {
    ...
    try {
      ...
      _this.floatyWindow.controlPanel.delete.setVisibility(8);
...
ControlPanelFloaty.prototype.restore = function() {
  ...
  ui.run(function () {
    ...
    try {
      ...
      _this.floatyWindow.controlPanel.delete.setVisibility(0);
